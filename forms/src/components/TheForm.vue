<template>
  <form @submit.prevent="submitForm">
    <div class="form-control">
      ...
      <p v-if="validity.username === 'invalid'">
        Please Type in a correct username
      </p>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <label for="confirm-terms">Confirm our Terms of use?</label>
    </div>
    <div>
...
<script>
  export default {
    ...
    methods: {
      ...
      validateInput(){
        if (this.userName === '') {
          this.validity.username = "invalid";
        } else {
          this.validity.username = "valid";
        }
      }
    }
  }
